...
SERVER_EMAIL = 'Capy Judge<admin@example.com>'
...
SITE_NAME = 'Capy Judge'
SITE_FULL_URL = 'https://capyjudge.io.vn'
SITE_LONG_NAME = 'Capy Judge'
SITE_ADMIN_EMAIL = 'admin@example.com'
TERMS_OF_SERVICE_URL = '//capyjudge.io/vn/tos/'  # Use a flatpage.
